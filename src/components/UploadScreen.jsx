    ...
    <div className="editor-layout">
      ...
      <div style={{ textAlign: 'center', marginTop: '2rem' }}>
        ...
        >
          ...
          Fazer um upload de clip
        </button>
        <p style={{ color: '#888', fontSize: '0.85rem', marginTop: '0.8rem', maxWidth: '400px', margin: '0.8rem auto 0' }}>
          <strong style={{ color: '#a0a0a0' }}>Aviso:</strong> Esta opção não abre o editor de vídeos. Ela apenas envia um clipe que você já tem pronto no seu dispositivo direto para a galeria.
        </p>
      </div>
