    ...
    <div className="editor-layout">
      ...
      <div className="upload-screen">
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <p style={{ color: '#a0a0a0', fontSize: '1.2rem', maxWidth: '600px', margin: '0 auto' }}>{t('upload.desc')}</p>
        </div>
      ...
      <div className="mobile-only" style={{ textAlign: 'center', padding: '2rem', background: 'rgba(239, 68, 68, 0.1)', border: '1px solid rgba(239, 68, 68, 0.3)', borderRadius: '12px' }}>
        ...
        <p style={{ marginTop: '8px' }}>{t('upload.pcRequiredDesc')}</p>
      </div>
      ...
      <div style={{ textAlign: 'center', marginTop: '2rem' }}>
        ...
        >
          ...
          {t('upload.uploadReady')}
        </button>
        <p style={{ color: '#888', fontSize: '0.85rem', marginTop: '0.8rem', maxWidth: '400px', margin: '0.8rem auto 0' }}>
          <strong style={{ color: '#a0a0a0' }}>{t('upload.warningTitle')}</strong> {t('upload.warningDesc')}
        </p>
      </div>
